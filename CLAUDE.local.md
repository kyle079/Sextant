...
**YOU ARE IN: `sextant/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/sextant/` (rig root) or other directories
...
**Your mail address:** `sextant/polecats/obsidian`
**Your rig:** sextant
**Your Witness:** `sextant/witness`
...
| Ask Witness for help | `gt mail send sextant/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`sextant/witness`) when:
...
```bash
gt mail send sextant/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
